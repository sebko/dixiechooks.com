...
// typography	
	...
	// content headings colour
		...
		.blog .entry-title a, .blog .entry-title a:visited, .archive .entry-title a, .archive .entry-title a:visited {color:" . esc_attr($blog_post_heading) . "; }
		.blog .entry-title a:hover, .archive .entry-title a:hover {color:" . esc_attr($content_link_colour) . "; }"."\n";
	...
	// bottom text and links
		$bottom_bg = get_theme_mod( 'bottom_bg', '#333' );
		...
		#sidebar-bottom .widget-title, #sidebar-bottom, #sidebar-bottom a, #sidebar-bottom a:visited, #sidebar-bottom .widget a, #sidebar-bottom .widget a:visited {color:" . esc_attr($bottom_text_colour) . "; }
		#sidebar-bottom .widget a:hover {color:" . esc_attr($bottom_link_hcolour) . "; }

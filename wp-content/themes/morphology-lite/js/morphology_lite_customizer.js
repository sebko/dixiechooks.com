jQuery(document).ready(function() {
	...
	if( !jQuery( ".morphology-info" ).length ) {
		...
		jQuery('.morphology-info').append('<a style="width: 80%; margin: 5px auto 5px auto; display: block; text-align: center;" href="https://www.shapedpixels.com/premium-wordpress-themes/morphology/" class="button" target="_blank">{pro}</a>'.replace('{pro}',morphologyliteCustomizerObject.pro));
